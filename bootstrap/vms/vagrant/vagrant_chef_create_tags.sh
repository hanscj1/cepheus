...
do_on_node $CEPH_CHEF_BOOTSTRAP "$KNIFE tag create ceph-vm1.example.com 'ceph-adc' $CHEF_KNIFE_DEBUG"
do_on_node $CEPH_CHEF_BOOTSTRAP "$KNIFE tag create ceph-vm2.example.com 'ceph-adc' $CHEF_KNIFE_DEBUG"
do_on_node $CEPH_CHEF_BOOTSTRAP "$KNIFE tag create ceph-vm3.example.com 'ceph-adc' $CHEF_KNIFE_DEBUG"
